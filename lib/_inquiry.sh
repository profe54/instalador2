...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Inserta el enlace GITHUB de tu HybsChat que deseas instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
get_max_whats() {
  ...
  print_banner
  printf "${WHITE} 💻 Informar el número de conexiones/WhatsApp que ${instancia_add} puede registrar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " max_whats
}
...
get_max_user() {
  ...
  print_banner
  printf "${WHITE} 💻 Informar el número de usuarios/asistentes que ${instancia_add} puede registrar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " max_user
}
...
get_frontend_url() {
  ...
  print_banner
  printf "${WHITE} 💻 Introduzca el dominio FRONTEND/PANEL para ${instancia_add}:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " frontend_url
}
...
get_backend_url() {
  ...
  print_banner
  printf "${WHITE} 💻 Introduzca el dominio BACKEND/API para ${instancia_add}:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " backend_url
}
...
get_backend_port() {
  ...
  print_banner
  printf "${WHITE} 💻 Introduzca el puerto BACKEND para esta instancia; Ex: 4000 A 4999 ${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " backend_port
}
...
get_redis_port() {
  ...
  print_banner
  printf "${WHITE} 💻 Introduzca el puerto REDIS/AGENDAMENTO MSG para ${instancia_add}; Ex: 5000 A 5999 ${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " redis_port
}
